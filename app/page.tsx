  ...
  return (
    <div>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        {/* Overlay قوى يخلى النافبار والنص يبانوا */}
        <div className="absolute inset-0 bg-black/50 -z-10"></div>

        {/* طبقة Gradient خفيفة للعمق البصرى */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-black/50 -z-10"></div>

        <div className="max-w-5xl px-6">

          <h1
            className={`${playfair.className} text-6xl md:text-8xl font-semibold text-white leading-[1.05] drop-shadow-xl`}
          >
            Handmade <br /> With Soul
          </h1>
